package com.politecarrot.tiderunner;
...
public class MainActivity extends BridgeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // -- Apply system-bar padding ONLY on Android 15+ ----------------
        ...
        // listener would double-pad and leave a black strip. Android 15+
        // (API 35+) mandates edge-to-edge and the listener is the only way
        // to reclaim that space, so scope the padding to that runtime.
